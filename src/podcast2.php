  ...
  <body>
    ...
    <div class="banner-container">
      <div class="next-bottle-banner-2">
        <a class="next-bottle drinking-next" href="podcast.php">MY BITCHIN WINE TALKSHOW</a>
      </div>
    </div>
    ...
    <div class="bottom-banner bottom-banner-2">
      <a class="lastest-episode-link next-bottle next-episode-link" href="podcast.php">LISTEN TO THE LATEST EPISODE</a>
    </div> 
    </div>
    <div class="copyright">
